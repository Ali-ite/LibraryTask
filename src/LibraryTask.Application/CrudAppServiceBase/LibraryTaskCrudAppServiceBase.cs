...
{
    public abstract class LibraryTaskCrudAppServiceBase<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
      : ApplicationService
      ...
      where TUpdateInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected LibraryTaskCrudAppServiceBase(IRepository<TEntity, TPrimaryKey> repository)
        {
