...
{
    public abstract class LibraryTaskWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryTaskWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryTaskWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryTaskDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryTaskDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryTaskDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryTaskDbContext, Task<T>> func)
        {
            T result;
